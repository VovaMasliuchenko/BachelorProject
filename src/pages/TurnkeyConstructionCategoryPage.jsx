...
import turnkeyCategoryHero from "../assets/turnkeyConstructionCategoryHero.png"
...
function TurnkeyConstructionCategoryPage() {
    ...
    return (
        ...
        <div className="flex flex-col justify-center items-center">
            <div>
                <img src={turnkeyCategoryHero} className="bg-fixed"/>
            </div>
            <div className="pt-16 pb-16 pr-32 pl-32 space-y-5 flex flex-col">
                <h1 className="font-goldman font-bold text-4xl">Turnkey<br/>Construction</h1>
                <div className="space-y-5">
                    <div className="flex flex-wrap">
                    {pagedRecords.map((product) => {
                        return (
                        ...
                        <div class="px-5 pb-5 flex items-center justify-between">
                            <h5 class="text-xl font-goldman font-regular">{product.type}</h5>
                            <FaRegHeart/>
                        </div>
                        <div class="px-5 pb-5 flex items-center justify-between">
                            <h5 class="text-button-orange font-inter font-regular">{product.price}$</h5>                 
                            <button className="border-2 border-button-orange hover:bg-button-orange hover:text-white p-2 transition font-goldman" onClick={() => addProductToCart(product.imageUrl, product.type, product.price)}>Add to cart</button>
                        </div>
                        </div>
                        </div>
                    );
                ...
                <div class="flex items-center justify-center py-10 lg:px-0 sm:px-6 px-4">
                    <div class="lg:w-5/5 w-full  flex items-center justify-between border-t border-gray-200">
                        <div class="flex items-center pt-3 text-gray-600 hover:text-indigo-700 cursor-pointer" onClick={previousPage}>
                        ...
                        <div class="flex items-center pt-3 text-gray-600 hover:text-indigo-700 cursor-pointer" onClick={nextPage}>
...
export default TurnkeyConstructionCategoryPage;